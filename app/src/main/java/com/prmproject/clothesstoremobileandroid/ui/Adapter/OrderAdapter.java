...
////            holder.txtQuantityValue.setText(String.valueOf(order.getQuantity()));
...
//        TextView txtOrderNumber, txtStatus, txtOrderDate, txtQuantityValue, txtTotalAmountValue;
//        Button detailButton;
//
...
//        //    txtQuantityValue = itemView.findViewById(R.id.txt_quantity_value);
//            txtTotalAmountValue = itemView.findViewById(R.id.txt_total_amount_value);
//
//            detailButton = itemView.findViewById(R.id.detail_btn); // Reference to the Detail button
//
//        }
//    }
//}
